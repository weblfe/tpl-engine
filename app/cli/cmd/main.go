...
import (
	...
	"github.com/weblfe/tpl-engine/pkg/filters"
	"github.com/weblfe/tpl-engine/pkg/templating"
	"io/ioutil"
	"os"
	"path"
	"path/filepath"
...
var customFilters = map[string]CustomFilterSpec{
	"write_file": {filters.FilterWriteFile, filters.FilterNoopPassthru},
	"make_dirs":  {filters.FilterMakeDirs, filters.FilterNoopPassthru},
}
